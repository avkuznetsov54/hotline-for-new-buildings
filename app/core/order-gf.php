...
$field_name_jk = 'Горячая линия по Новостройкам';
...
// /* Указываем переменные, в которые будет записываться информация с формы */
     ...
     $subject = "Заявка с LandingPage $field_name_jk";//Фиксированная тема письма
...
$data['entry.349942968'] = $field_name_jk;  // Landing Page
